...
const title = "这周哪里天气好？未来7天基本不下雨城市排行 | Where Not Rain";
const description =
  "比较热门旅行地未来7天基本不下雨的天数、预计总降雨和最高降雨概率，快速找到这周更适合出游的城市。";
...
export default async function Page(): Promise<ReactElement> {
  ...
  const items = buildWeeklyWeatherRanking(dataset, "zh-cn");
  ...
  return (
    <>
      <BestWeatherThisWeekPage
        ...
        jsonLd={jsonLd}
      />
      <SocialWeatherShareCard locale="zh-cn" mode="week" pageUrl={pageUrl} items={topItems.slice(0, 3)} />
    </>
  );
}
