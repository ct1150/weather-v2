...
export const metadata: Metadata = {
  ...
  description:
    "Route-aware trip execution with fixed constraints, hotel anchors and weather replanning.",
    ...
    <main id="main-content" className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10">
      <nav className="country-breadcrumb" aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <a href="/trips/workspace">Trip workspace</a>
          </li>
          <li>Execution mode</li>
        </ol>
      </nav>
      <div className="mt-6">
        <TripExecutionWorkspace locale="en" />
      </div>
