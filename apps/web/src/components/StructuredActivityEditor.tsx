...
const COPY = {
  en: {
    ...
    intro:
      "Weather-aware metadata powers concrete Plan B suggestions now and safe replanning later.",
    ...
    noPoi:
      "No curated POI catalogue is available for this city yet. Generic Plan B remains available.",
  },
  "zh-cn": {
    title: "结构化活动",
