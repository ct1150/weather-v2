...
export function SmartTripImportForm({ locale = "zh-cn" }: SmartTripImportFormProps): ReactElement {
  ...
  const copy = isEnglish
    ? {
        ...
        nextDescription:
          "Cities we can match are filled in. Anything uncertain stays blank for you to confirm.",
    ...
    : isTraditional
      ? {
          ...
          next: "繼續前確認一下",
          nextDescription: "能確定的城市已經填好；不確定的地方會留空，進入工作台後再確認。",
          create: "建立我的天氣行程",
          unresolved: "需要確認城市",
        }
      : {
          ...
          next: "继续前确认一下",
          nextDescription: "能确定的城市已经填好；不确定的地方会留空，进入工作台后再确认。",
          create: "创建我的天气行程",
          unresolved: "需要确认城市",
        };
