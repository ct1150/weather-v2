...
import { buildCountryWeeklyWeatherRanking } from "./country-weekly-weather-ranking";

describe("country weekly weather ranking", () => {
  it("keeps every ranked city inside the requested country with stable localized order", async () => {
